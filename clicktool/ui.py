...
class ClickerApp:
    ...
    def _build_settings_ui(self, frame) -> None:
        ...
        bg_frame = ttk.LabelFrame(scrollable_frame, text="Window Mode", padding=10)
    ...
    def remove_target_window(self):
        ...
        for i in reversed(to_remove):
            if "dot" in self._window_positions[i]:
        ...
        def _proc(nCode, wParam, lParam):
            ...
            try:
                if nCode == HC_ACTION:
                    ...
                    # doesn't act on Win+R, Win+E, Alt+Tab, etc. The 15s
                    # capture watchdog (_arm_capture_watchdog) is the safety
                    # net that uninstalls the hook even if the user walks away.
